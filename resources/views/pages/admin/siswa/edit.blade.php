                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-select">
                            ...
                            <option value="Laki-laki" @selected(old('jenis_kelamin', $siswa->jenis_kelamin) == 'Laki-laki')>
                                Laki-laki
                            </option>
                            <option value="Perempuan" @selected(old('jenis_kelamin', $siswa->jenis_kelamin) == 'Perempuan')>
                                Perempuan
                            </option>
                        </select>
                        @error('jenis_kelamin')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="alamat" id="alamat" value="{{ old('alamat', $siswa->alamat) }}"
