                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            value="{{ old('nama', $wali_kelas->nama) }}">
                        @error('nama')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="tempat_lahir" id="tempat_lahir"
                            ...
                            value="{{ old('tempat_lahir', $wali_kelas->tempat_lahir) }}">
                        @error('tempat_lahir')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="alamat" id="alamat" cols="30" rows="3"
                            class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $wali_kelas->alamat) }}</textarea>
                        @error('alamat')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                            </span>
